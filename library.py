...
# #                 self.dateborrowed_var.set(d1)
# #                 self.datedue_var.set(d3)
# #                 self.days_var.set(random.randint(10, 30))
# #                 self.latereturnfine_var.set("TK:" + str(random.randint(10, 50)))
# #                 self.dateoverdue_var.set("NO")
# #                 self.finalprice_var.set("TK:" + str(random.randint(200, 800)))
...
# #             elif x == "Ruby Handbook":
# #               self.bookid_var.set("BKID1456")
# #               self.booktitle_var.set("Ruby Handbook")
# #               self.auther_var.set("Ruby Smith")
# #               d1 = datetime.datetime.today()
# #               d2 = datetime.timedelta(days=15)
# #               d3 = d1 + d2
# #               self.dateborrowed_var.set(d1)
...
# #         # Add Data Button
# #         btnAddData = Button(framebutton, command=self.adda_data, text="Add Data", font=("arial", 13, "bold"), width=23,
# #         bg="blue", fg="white")
# #         btnAddData.grid(row=0, column=0)

# #         # Show Data Button
# #         btnShowData = Button(framebutton,command=self.showData, text="Show Data", font=("arial", 13, "bold"),  width=23,
# #         bg="green", fg="white")
# #         btnShowData.grid(row=0, column=1)
          
# #         # Update Button
# #         btnUpdate = Button(framebutton, text="Update", font= ("arial", 13, "bold"), width=23, bg="orange", fg="white")
# #         btnUpdate.grid(row=0, column=2)
          
# #         # Delete Button
# #         btnDelete = Button(framebutton, text="Delete", font=                ("arial", 13, "bold"),width=23, bg="red", fg="white")
# #         btnDelete.grid(row=0, column=3)
          
# #           # Reset Button
# #         btnReset = Button(framebutton, text="Reset", font=("arial",                 13, "bold"), width=23, bg="purple", fg="white")
# #         btnReset.grid(row=0, column=4)
          
# #           # Exit Button
# #         btnExit = Button(framebutton, text="Exit", font=("arial",                 13, "bold"), width=23, bg="gray", fg="white")
...
# #         self.library_table=ttk.Treeview(Table_frame,columns=("memberType","prnno","title", "firstname","lastname","address1", "address2", "postid", "mobile","bookid", "booktitle", "auther","dateborrowed",
...
# #        # Set column widths
# #         columns = ["memberType", "prnno", "title", "firstname", "lastname", "address1", 
...
# # def adda_data(self):
# #     conn = mysql.connector.connect(host="localhost", username="root", password="ASdf12@#", database="edulibrarydb")
# #     my_cursor = conn.cursor()
# #     my_cursor.execute("insert into edulibrarydb values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,)",
# #                       (self.member_var.get(), self.prn_var.get(), self.title_var.get(),
# #                        self.firstname_var.get(), self.lastname_var.get(), self.address1_var.get(),
# #                        self.address2_var.get(), self.postid_var.get(), self.mobile_var.get(),
# #                        self.bookid_var.get(), self.booktitle_var.get(), self.auther_var.get(),
# #                        self.dateborrowed_var.get(), self.datedue_var.get(), self.days_var.get(),
...
# #     def fetch_data(self):  # Moved inside the class
# #         conn = mysql.connector.connect(host="localhost", username="root", password="ASdf12@#", database="edulibrarydb")
# #         my_cursor = conn.cursor()
...
#       # Add Data Button
#         btnAddData = Button(framebutton, command=self.add_data, text="Add Data", font=("arial", 13, "bold"), width=23, bg="blue", fg="white")
#         # Show Data Button
#         btnShowData = Button(framebutton, command=self.showData, text="Show Data", font=("arial", 13, "bold"), width=23,
#                              bg="green", fg="white")
#         btnShowData.grid(row=0, column=1)
