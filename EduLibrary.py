...
class LibraryManagementSystem:
    def __init__(self, root):
        ...
        lblLastReturnDate = Label(
            DataFrameLeft,
            text="Last Return Date",
            bg="powder blue",
            font=("arial", 12, "bold"),
            padx=2,
        )
        ...
        listbox = Listbox(
            DataFrameRight, font=("arial", 13, "bold"), width=20, height=16
        )
